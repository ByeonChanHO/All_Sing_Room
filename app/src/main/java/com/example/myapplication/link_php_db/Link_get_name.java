...
public class Link_get_name extends AppCompatActivity {
    ...
    public void Start_insert(){
        ...
        task.execute("http://" + IP_ADDRESS + "/getProject.php", Kakaoid,name,intro,urimage, advan, opentime, holiday, phonenum, whereroom, wheremap, comadd, comnum);
